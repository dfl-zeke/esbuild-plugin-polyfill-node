...
var import_meta = {};
var filename = typeof __filename === "undefined" ? (0, import_url.fileURLToPath)(import_meta.url) : __filename;
var importMetaUrl = import_meta.url ?? (0, import_url.pathToFileURL)(filename).href;
    ...
    setup(build) {
      build.onResolve({ filter }, async ({ path, importer }) => {
        ...
        if (polyfill === false) {
          ...
          return {
            path: (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/empty.js")
          };
        } else if (moduleName === "inherits" && importer === await resolveImport("util/util.js")) {
          return {
            path: (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/inherits.js")
          };
      ...
      build.initialOptions.inject.push(
        (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/global.js"),
        (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/__dirname.js"),
        (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/__filename.js")
      );
      if (buffer) {
        build.initialOptions.inject.push(
          (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/buffer.js")
        );
      }
      if (process) {
        build.initialOptions.inject.push(
          (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/process.js")
        );
      }
    }
  };
  ...
  return {
    ...
    setup(build) {
      ...
      if (globals) {
        ...
        build.initialOptions.inject = build.initialOptions.inject || [];
        build.initialOptions.inject.push(
          (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/global-for-deno.js"),
          (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/__dirname.js"),
          (0, import_path.resolve)((0, import_path.dirname)(filename), "../polyfills/__filename.js")
        );
      }
